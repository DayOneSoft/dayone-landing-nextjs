      ...
      <main>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-r from-primary-600 to-accent-600" aria-labelledby="cta-heading">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-primary-50 hover:text-primary-600" onClick={scrollToContact}>
              Learn More
            </Button>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <a href="https://wa.me/8801723019985" target="_blank" rel="noopener noreferrer" className="text-secondary-700 hover:text-green-600 transition-colors duration-200 flex items-center cursor-pointer">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="https://wa.me/8801759412381" target="_blank" rel="noopener noreferrer" className="text-secondary-700 hover:text-green-600 transition-colors duration-200 flex items-center cursor-pointer">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="https://wa.me/8801747413273" target="_blank" rel="noopener noreferrer" className="text-secondary-700 hover:text-green-600 transition-colors duration-200 flex items-center cursor-pointer">
